...
import (
	...
	"github.com/nimrodoron/simple-ingress-controller/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type SamplecontrollerV1alpha1Interface interface {
	RESTClient() rest.Interface
	SimpleIngressRulesGetter
}
...
func (c *SamplecontrollerV1alpha1Client) SimpleIngressRules(namespace string) SimpleIngressRuleInterface {
	return newSimpleIngressRules(c, namespace)
}
